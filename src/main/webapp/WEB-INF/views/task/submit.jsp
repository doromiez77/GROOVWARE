...
<div class="right-contentbody">
	<div class="body-container">	
		<div class="body-title pj-title">
			<h2><i class="fa-solid fa-clipboard-check"></i> 업무 제출 </h2>
		...
		<div class="body-main">
			...
			<form name="taskForm" method="post" class="myForm" enctype="multipart/form-data">
					...
					<table class="table table-border border-top2 table-form main-table">
						...
						<tr>
							<th>제&nbsp;&nbsp;출&nbsp;&nbsp;자</th>
							<td>
								${sessionScope.member.emp_name}(${sessionScope.member.pos_name}_${sessionScope.member.dept_name})
							</td>
						</tr>
						...
						<tr>
							<th>기&nbsp;&nbsp;&nbsp;&nbsp;간</th>
							<td> 
								${dto.task_start_date} ~ ${dto.task_end_date}
							</td>
						</tr>
						...
						<tr>
							<th>코&nbsp;&nbsp;멘&nbsp;&nbsp;트</th>
							<td> 
								<textarea name="task_comment" class="form-control"></textarea>
							</td>
						</tr>
					...
					<table class="table">
						<tr>
							<td class="text-end" style= "text-align: left;">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/task/listreceive?${query}';"><i class="fa-solid fa-rotate-left"></i></button>
							</td>
							<td style="float: right;">
								<button type="reset" class="btn">다시입력&nbsp;</button>
								<button type="button" class="btn btn-dark" onclick="sendOk();">제출하기</button>
							</td>
						</tr>
					</table>
